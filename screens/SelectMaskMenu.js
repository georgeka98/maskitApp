...
export default function AddMask({navigation}) {
  ...
  // render() {
    ...
    const viewYourMasks = () => {
      navigation.push('Your Masks')
    }

    const viewMasks = () => {
      navigation.push('Select Mask')
    }
    ...
    return (
      ...
      {/* <View style={[styles.maskExpand]}>
        ...
        <ScrollView>
          ...
          <TouchableWithoutFeedback onPress={()=> {viewMasks()}}>
          <View style={[styles.button, styles.shadow, styles.prevMask]}>
                <View style={[styles.btnIcon ]}>
                  <Image source={ require('../assets/search.png') } style={styles.imageStyle} />
                </View>
                <View style={[styles.btnInfo]}>
                  <Text style={[styles.btnInfoHeader, {color: "white"}]}>Find Masks</Text>
                </View>
              </View>
          </TouchableWithoutFeedback>

          <TouchableWithoutFeedback onPress={()=> {viewYourMasks()}}>
          <View style={[styles.button, styles.shadow, styles.prevMask]}>
                <View style={[styles.btnIcon ]}>
                  <Image source={ require('../assets/mask-white-blue-bg.png') } style={styles.imageStyle} />
                </View>
                <View style={[styles.btnInfo]}>
                  <Text style={[styles.btnInfoHeader, {color: "white"}]}>Your Masks</Text>
                </View>
              </View>
          </TouchableWithoutFeedback>
